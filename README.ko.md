...
색상 선택창 안의 스포이드를 사용하려면 YourPicker 공식 릴리스의 `YourPicker_v1.6.0.rmskin`을 설치한 뒤 Rainmeter를 새로고침하세요. YourPicker DLL은 이 스킨에 포함하지 않으며, 설치하지 않아도 팔레트와 RGB·HEX 입력은 그대로 사용할 수 있습니다.

## 릴리스 파일로 설치하기

1. [GoogleCalendar_1.1.0.rmskin](https://github.com/maxhong-1999/rainmeter-google-calendar/releases/download/v1.1.0/GoogleCalendar_1.1.0.rmskin)을 다운로드합니다.
...
v1.1.0 SHA-256: `185E21F28431C0CE41A09AF7CCEADD60B8DAA141FB5B5F79099012D37774F28E`

v1.1.0에는 오늘 날짜 테두리, HEX·RGB 입력, 색상 선택창 내부 스포이드와 색상 읽기 오류 수정이 포함됩니다. 화면 추출에는 별도 YourPicker 설치가 필요하며 DLL은 포함하지 않습니다. 업데이트 시 기존 일정·계정 설정을 보존하도록 `VariableFiles`가 지정되어 있습니다.
